      ...
      <div class="col-md-12">
        <div class="widget box">
          <div class="widget-header">
            <h4><i class="icon-reorder"></i>Create New Internal System User Account</h4>
        ...
        <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6 hidden CountyControls">
          <label>County Name</label>
          <span class="input-icon icon-right">
            {{ Form::select('county_id',([null=>'--Select County--'] + $counties), $model->sid, ['class'=>'form-control','required'=>false,'id'=>'CountyId','style'=>'width:100%']) }}
