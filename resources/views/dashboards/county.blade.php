					...
					<div class="col-sm-6 col-md-3 hidden-xs">
						<div class="statbox widget box box-shadow">
							<div class="widget-content">
								...
								<a class="more" href="{{url('/System/TrainingModule/Index')}}">View More <i class="pull-right icon-angle-right"></i></a>
							</div>
						</div> <!-- /.smallstat -->
					</div> <!-- /.col-md-3 -->
				</div> <!-- /.row -->
...
<div class="row">
					...
					<div class="col-md-6" style="margin-top:1%;">
							<div class="widget box">
							<div class="widget-header">
								<h4><i class="icon-reorder"></i>VCO Statistics By Value Chains</h4>
								<div class="toolbar no-padding">
									<div class="btn-group">
										<span class="btn btn-xs widget-collapse"><i class="icon-angle-down"></i></span>
									</div>
							...
							<select id="CountyId" class="form-control">
								 <option value="">---Select County---</option>
								  <?php foreach($models as $model):?>
								  	<option value="{{$model->id}}">{{$model->county_name}}</option>
