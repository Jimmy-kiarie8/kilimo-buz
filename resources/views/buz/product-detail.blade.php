...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="">
            <div class="relative">
                <img src="{{ asset('MemberProducts/' . $product->product_image) }}" alt="Product Image" class="w-full h-150 object-cover rounded-lg">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4 mb-8">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-gray-700">Seller Phone: <a href="tel:{{ $product->sellermobilenumber }}">{{ $product->sellermobilenumber }}</a></span>
                </div>
            </div>
            ...
            <div class="flex space-x-4">
                <button class="flex-1 bg-white border border-green-600 text-green-600 py-3 px-6 rounded-lg hover:bg-green-50 transition-colors" onclick="window.location.href='tel:{{ $product->sellermobilenumber }}'">
                    <i class="fas fa-phone-alt mr-2"></i>
                    Contact Seller
                </button>
                <button class="flex-1 bg-white border border-green-600 text-green-600 py-3 px-6 rounded-lg hover:bg-green-50 transition-colors">
                    <i class="fas fa-mobile-alt mr-2"></i>
                    Open On App
                </button>

                <button class="flex-1 bg-white border border-green-600 text-green-600 py-3 px-6 rounded-lg hover:bg-green-50 transition-colors" onclick="window.open('https://maps.google.com/?q={{ $product->latitude }},{{ $product->longitude }}', '_blank')">
            ...
            <div class="flex space-x-4">
            <button class="flex-1 bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent(window.location.href), '_blank')">
                <i class="fab fa-facebook-f mr-2"></i>
                Share
            </button>
            <button class="flex-1 bg-blue-400 text-white py-3 px-6 rounded-lg hover:bg-grey-500 transition-colors" onclick="window.open('https://x.com/intent/tweet?url='+encodeURIComponent(window.location.href), '_blank')">
                <i class="fab fa-x mr-2"></i>
            </button>
            <button class="flex-1 bg-green-600 text-white py-3 px-6 rounded-lg hover:bg-green-700 transition-colors" onclick="window.open('https://wa.me/?text='+encodeURIComponent(window.location.href), '_blank')">
                <i class="fab fa-whatsapp mr-2"></i>
                WhatsApp
            </button>
            <button class="flex-1 bg-red-600 text-white py-3 px-6 rounded-lg hover:bg-red-500 transition-colors" onclick="window.open('https://www.instagram.com/sharer/sharer.php?u='+encodeURIComponent(window.location.href), '_blank')">
    ...
    <div class="mt-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden group">
                <div class="relative">
                    <img src="{{ asset('MemberProducts/' . $related->product_image) }}" alt="Related Product" class="w-full h-48 object-cover">
                    <div class="absolute top-2 right-2">
