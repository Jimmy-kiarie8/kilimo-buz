...
<footer class="w-full bg-green-800 text-white">
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                <h5 class="text-xl font-bold mb-6">Personal safety tips</h5>

                <li class="text-gray-300 hover:text-white transition-colors">Do not pay in advance, even for the delivery</li>
                <li class="text-gray-300 hover:text-white transition-colors">Try to meet at a safe, public location</li>
                <li class="text-gray-300 hover:text-white transition-colors">Check the item BEFORE you buy it</li>
                <li class="text-gray-300 hover:text-white transition-colors">Pay only after collecting the item</li>
                <li class="text-gray-300 hover:text-white transition-colors">Do not give out your personal information</li>
                <li class="text-gray-300 hover:text-white transition-colors">Do not send money without meeting the seller</li>
                {{-- <form class="mt-4">
                    <div class="flex flex-col space-y-3">
                        <input
                            type="email"
                            placeholder="Your email address"
                            class="px-4 py-2 bg-gray-700 text-white rounded focus:outline-none focus:ring-2 focus:ring-green-500 w-full"
                        >
                        <button
                            type="submit"
        ...
        {{-- <div class="mt-12 border-t border-gray-600 pt-8">
            <h6 class="text-sm font-semibold mb-4">Accepted Payment Methods</h6>
            <div class="flex flex-wrap gap-4">
                <div class="bg-white p-2 rounded w-12 h-8 flex items-center justify-center">
                ...
                <div class="bg-white p-2 rounded w-16 h-8 flex items-center justify-center">
                    <span class="text-gray-800 font-bold text-xs">APPLE PAY</span>
                </div>
            </div>
        </div> --}}
    </div>
    ...
    <div class="bg-green-900 py-6">
        <div class="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
            <div class="text-sm text-gray-400">
                &copy; 2025 Kilimo Buz. All rights reserved.
            </div>
